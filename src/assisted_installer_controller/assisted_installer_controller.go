...
type ControllerConfig struct {
	...
	DryRunEnabled           bool   `envconfig:"DRY_ENABLE" required:"false" default:"true"`
	DryRunHostname          string `envconfig:"DRY_HOSTNAME" required:"false" default:""`
	DryMcsAccessIp          string `envconfig:"DRY_MCS_ACCESS_IP" required:"false" default:""`
